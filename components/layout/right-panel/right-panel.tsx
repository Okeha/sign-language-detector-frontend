    ...
    <aside className="flex h-full w-[450px] flex-col border-l bg-sidebar">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 flex flex-col p-4">
          ...
          <div className="flex-1 rounded-lg overflow-hidden bg-gradient-to-br from-purple-50/50 to-blue-50/50 dark:from-purple-950/20 dark:to-blue-950/20 shadow-inner">
            <ModelViewer />
          </div>
        </div>
      </div>
